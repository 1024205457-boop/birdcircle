...
1. **首页浏览**：查看天气、附近鸟点推荐和最近鸟讯动态
2. **地图探索**：切换到地图 Tab，点击鸟点查看鸟种列表、活跃度和鸟讯统计
3. **上传鸟讯**：点击底部「+」，选择照片上传，等待 AI 识鸟结果
4. **确认发布**：点击「提交鸟讯」，查看完整闭环提示（已识别 → 已同步相册 → 已贡献鸟讯 → 获得积分）
5. **相册归档**：切换到相册 Tab，查看按鸟种归档的照片堆，支持滑动浏览和 ZIP 导出
